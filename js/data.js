...
const EVENTS = [

  {
    ...
    subtitle:'室內樂 × 排灣族古謠 · Feel the Roots.',
    subtitle_en:'Chamber Music × Paiwan Ancient Ballads · Feel the Roots.',
  ...
  },
  {
    ...
    subtitle:'Feel the Flight.',
    subtitle_en:'Feel the Flight.',
  ...
  },
  {
    ...
    subtitle:'Feel the Wave.',
    subtitle_en:'Feel the Wave.',
  ...
  /* ── 街頭與生活 · 主要活動 ── */
  {
    ...
    desc:'布希維克街頭藝術節是紐約布魯克林 Bushwick 區一年一度的大型街頭藝術與音樂節慶，結合即席壁畫創作、嘻哈舞台、DJ、餐車與在地市集，將整個社區變成開放式戶外美術館。',
  ...
  },
  {
    ...
    date:'2026-06-28',
    time:'2026 年 6 月 28 日，中午 12:00 出發',
    time_en:'June 28, 2026. Starting at 12:00 p.m.',
    title:'2026 紐約同志遊行',
    title_en:'2026 New York City Pride March',
    subtitle:'Nymphia Wind × Tina Banana × Yolanda Mesula · Feel the Drag.',
    subtitle_en:'Nymphia Wind × Tina Banana × Yolanda Mesula · Feel the Drag.',
    location:'第26街與第五大道出發，途經石牆國家紀念碑，終點於第15街與第七大道',
    location_full:'Starting at 26th Street and 5th Avenue in Manhattan, passing the Stonewall National Monument, and ending near 15th Street and 7th Avenue',
